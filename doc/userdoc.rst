...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [DiffBotArduinoHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [DiffBotArduinoHardware]: Got command 50.00000 for 'right_wheel_joint'!
...
6. Let's introspect the ros2_control hardware component. Calling
  ...
  .. code-block:: shell
    ...
    Hardware Component 1
            name: DiffBot
            type: system
            plugin name: diffdrive_arduino/DiffBotArduinoHardware
  ...
  .. code-block:: shell
    ...
    ros2 launch diffdrive_arduino diffbot.launch.py use_mock_hardware:=True
