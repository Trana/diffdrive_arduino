...
{
  class DiffBotArduinoHardware : public hardware_interface::SystemInterface
  {
    ...
    struct Config
    {
      ...
      int baud_rate = 0;
      int timeout_ms = 0;
      int left_wheel_enc_counts_per_rev = 0;
      int right_wheel_enc_counts_per_rev = 0;
      int pid_p = 0;
      int pid_d = 0;
      int pid_i = 0;
      int pid_o = 0;
  ...
  public:
    RCLCPP_SHARED_PTR_DEFINITIONS(DiffBotArduinoHardware);
